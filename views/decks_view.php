        ...
        <div class="d-flex flex-row justify-content-center">
            <div class="col-md-2 me-3">
                <div class="sticky-top" style="top:5.625rem;">
                    ...
                    <a href="/decks/api?d=<?= $deck->display_id; ?>" target="_blank" class="d-block btn btn-outline-primary w-100 mt-3" type="button"><i class="bi bi-file-earmark-code-fill"></i> API JSON data</a>
